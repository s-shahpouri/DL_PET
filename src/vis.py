"""
This module provides various functions for visualizing ASC and non-ASC PET images.
The visualizations are designed for 
coronal and axial views, with support for adjusting contrast, applying 
custom color maps, and integrating with Streamlit for interactive 
dashboard displays.
